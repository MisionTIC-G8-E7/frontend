...
const CableadoEstructurado = () => {
  return (
    <>
      <Menu />
      <div className="row justify-content-center align-items-center p-5 fondo10 text-white h-auto">
        <div
        ...
        <div className="col-12 col-md-6 ">
          <img
            ...
            src="https://www.pcstoresoluciones.com/images/Image_PCS/redes.png"
            alt=""
          />
        </div>
      </div>
      <div className="row justify-content-center align-items-center p-5 fondoCard2 text-black h-auto">
        ...
        <div className="col-12 col-sm-10">
          ...
          <p>
            ...
            eligendi mollitia similique aperiam architecto quo omnis, ab natus
            non perspiciatis, recusandae officia deleniti porro corrupti facere,
            eos voluptatem quam tempore. Lorem ipsum, dolor sit amet consectetur
            adipisicing elit. Iste nemo officiis possimus nostrum assumenda illo
            corporis sapiente reiciendis commodi quod cupiditate veniam odio
            perferendis amet deleniti cum aperiam, voluptate quis!
          </p>
        </div>
        <div className="col-12 col-sm-1"></div>
      </div>
