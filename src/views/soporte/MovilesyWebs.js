...
const MovilesyWebs = () => {
  return (
    <>
      <Menu />
      <div className="row justify-content-center align-items-center p-5 fondo11 text-white h-auto">
          ...
          <div className="row ">
            <div className="col-4">
              <img
                ...
                src="https://abamobile.com/web/wp-content/uploads/2021/06/pagina-desarrollo-android.png"
                alt=""
              />
            </div>
            <div className="col-4">
              <img
                className="img-fluid rounded mx-auto d-block"
                src="https://abamobile.com/web/wp-content/uploads/2021/06/pagina-desarrollo-ios.png"
                alt=""
              />
            </div>
            <div className="col-4">
      ...
      <div className="row p-5 fondoCard2 justify-content-center align-items-center">
        <h2 className="fs-1 mb-5 text-center">
          El tipo de app que tu empresa necesita
        </h2>
